...
import cn.ruinflowlight.itemRegister.ToolMaterial.ChiHongTools;
...
public class chiHongXiLieReg {
    public static final ToolItem chiHongZhiRen = new SwordItem(new ChiHongTools(),
            8, -2.4F,
            new Item.Settings());
    public static final ToolItem chiHongZhiRen2 = new SwordItem(new ChiHongTools(),
            10, -2.4F,
            new Item.Settings());
    public static final ToolItem chiHongZhiRen3 = new SwordItem(new ChiHongTools(),
            12, -2.4F,
            new Item.Settings());
    public static final ToolItem ChiHongZhiRen4 = new SwordItem(new ChiHongTools(),
            14, -2.4F,
            new Item.Settings());
