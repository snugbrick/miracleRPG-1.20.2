package cn.ruinflowlight.ArmorReg;
...
public class AusterityReg {
    ...
    public static void ArmorRegister(){
        Registry.register(Registries.ITEM, new Identifier("miraclerpg", "austerity_material_helmet"), AUSTERITY_MATERIAL_HELMET);
        Registry.register(Registries.ITEM, new Identifier("miraclerpg", "austerity_material_chestplate"), AUSTERITY_MATERIAL_CHESTPLATE);
        Registry.register(Registries.ITEM, new Identifier("miraclerpg", "austerity_material_leggings"), AUSTERITY_MATERIAL_LEGGINGS);
        Registry.register(Registries.ITEM, new Identifier("miraclerpg", "austerity_material_boots"), AUSTERITY_MATERIAL_BOOTS);
    }
}
